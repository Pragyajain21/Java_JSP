 ...
 * Generated at: 2024-05-10 08:39:28 UTC
...
try {
    ...
    String query = "SELECT * FROM logincredentials WHERE username=? AND password=? AND role=?";
    ...
    if (rs.next()) {
        ...
        if (role.equals("legal")) {
            redirectPage = "legalDashboard.jsp";
        } else if (role.equals("management")) {
            redirectPage = "managementDashboard.jsp";
        } else if (role.equals("finance")) {
            redirectPage = "financeDashboard.jsp";
        }
